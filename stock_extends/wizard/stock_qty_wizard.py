...
class StockQtyWizard(models.TransientModel):
    _name = 'stock.qty.wizard'

    picking_status = fields.Selection([
        ('draft', 'Draft'),
        ('waiting', 'Waiting'),
        ('ready', 'Ready')
    ], string='Stock Picking Status', default='draft')

    @api.multi
    def proceed(self):
        # if self.picking_status == 'waiting':
        #     status = 'confirmed'
        # if self.picking_status == 'ready':
        #     status = 'assigned'
